...
.getfile=function(){var b=this,c=this.fm,d=function(c){var d=b.options;c=a.map(c,function(a){return a.mime!="directory"||d.folders?a:null});return d.multiple||c.length==1?c:[]};this.alwaysEnabled=!0,this.callback=c.options.getFileCallback,this._disabled=typeof this.callback=="function",this.getstate=function(a){var a=this.files(a),b=a.length;return this.callback&&b&&d(a).length==b?0:-1},this.exec=function(c){var d=this.fm,e=this.options,f=this.files(c),g=f.length,h=d.option("url"),i=d.option("tmbUrl"),j=a.Deferred().done(function(a){d.trigger("getfile",{files:a}),b.callback(a,d),e.oncomplete=="close"?d.hide():e.oncomplete=="destroy"&&d.destroy()}),k=[],l,m,n;if(this.getstate()==-1)return j.reject();for(l=0;l<g;l++){m=f[l];if(m.mime=="directory"&&!e.folders)return j.reject();m.baseUrl=h,m.url=d.url(http:// x10powered.com/errors/404.shtml),m.path=d.path(m.hash),m.tmb&&m.tmb!=1&&(m.tmb=i+m.tmb),m.dim?(n=m.dim.split("x"),m.width=n[0],m.height=n[1]):m.mime.indexOf("image")!==-1&&k.push(d.request({data:{cmd:"dim",target:m.hash},preventDefault:!0}).done(a.proxy(function(a){a.dim&&(n=a.dim.split("x"),this.width=n[0],this.height=n[1]),this.dim=a.dim},f[l])))}if(k.length){a.when.apply(null,k).always(function(){j.resolve(e.multiple?f:f[0])});return
																																																																																																																																																																																																												...
																																																																																																																																																																																																												// ui-widget-header
																																																																																																																																																																																																												// ui-corner-all">'],p='<div
																																																																																																																																																																																																												// class="elfinder-help-shortcut"><div
																																																																																																																																																																																																												// class="elfinder-help-shortcut-pattern">{pattern}</div>
																																																																																																																																																																																																												// {descrip}</div>',q='<div
																																																																																																																																																																																																												// class="elfinder-help-separator"/>',r=b.shortcuts();a.each({main:"about",shortcuts:"shortcuts",help:"help"},function(a,c){o.push(n[j](/\{id\}/,a)[j](/\{title\}/,b.i18n(c)))}),o.push("</ul>"),o.push('<div
																																																																																																																																																																																																												// id="main"
																																																																																																																																																																																																												// class="ui-tabs-panel
																																																																																																																																																																																																												// ui-widget-content
																																																																																																																																																																																																												// ui-corner-bottom"><div
																																																																																																																																																																																																												// class="elfinder-help-logo"/>'),o.push("<h3>elFinder</h3>"),o.push('<div
																																																																																																																																																																																																												// class="'+k+'">'+b.i18n("webfm")+"</div>"),o.push('<div
																																																																																																																																																																																																												// class="'+l+'">'+b.i18n("ver")+":
																																																																																																																																																																																																												// "+b.version+",
																																																																																																																																																																																																												// "+b.i18n("protocol")+":
																																																																																																																																																																																																												// "+b.api+"</div>"),o.push('<div
																																																																																																																																																																																																												// class="'+l+'">jQuery/jQuery
																																																																																																																																																																																																												// UI:
																																																																																																																																																																																																												// '+a().jquery+"/"+a.ui.version+"</div>"),o.push(q),o.push(d[j](f,"http://elfinder.org/")[j](g,b.i18n("homepage"))),o.push(d[j](f,"https://github.com/Studio-42/elFinder/wiki")[j](g,b.i18n("docs"))),o.push(d[j](f,"https://github.com/Studio-42/elFinder")[j](g,b.i18n("github"))),o.push(d[j](f,"http://twitter.com/elrte_elfinder")[j](g,b.i18n("twitter"))),o.push(q),o.push('<div
																																																																																																																																																																																																												// class="'+k+'">'+b.i18n("team")+"</div>"),o.push(e[j](h,'Dmitry
																																																																																																																																																																																																												// "dio"
																																																																																																																																																																																																												// Levashov
																																																																																																																																																																																																												// &lt;dio@std42.ru&gt;')[j](i,b.i18n("chiefdev"))),o.push(e[j](h,"Troex
																																																																																																																																																																																																												// Nevelin
																																																																																																																																																																																																												// &lt;troex@fury.scancode.ru&gt;")[j](i,b.i18n("maintainer"))),o.push(e[j](h,"Alexey
																																																																																																																																																																																																												// Sukhotin
																																																																																																																																																																																																												// &lt;strogg@yandex.ru&gt;")[j](i,b.i18n("contributor"))),b.i18[b.lang].translator&&o.push(e[j](h,b.i18[b.lang].translator)[j](i,b.i18n("translator")+"
																																																																																																																																																																																																												// ("+b.i18[b.lang].language+")")),o.push(q),o.push('<div
																																																																																																																																																																																																												// class="'+m+'">'+b.i18n("icons")+':
																																																																																																																																																																																																												// <a
																																																																																																																																																																																																												// href="http://pixelmixer.ru/"
																																																																																																																																																																																																												// target="_blank">Pixelmixer</a>,
																																																																																																																																																																																																												// <a
																																																																																																																																																																																																												// href="http://p.yusukekamiyamane.com"
																																																																																																																																																																																																												// target="_blank">Fugue</a></div>'),o.push(q),o.push('<div
																																																																																																																																																																																																												// class="'+m+'">Licence:
																																																																																																																																																																																																												// BSD
																																																																																																																																																																																																												// Licence</div>'),o.push('<div
																																																																																																																																																																																																												// class="'+m+'">Copyright
																																																																																																																																																																																																												// ©
																																																																																																																																																																																																												// 2009-2011,
																																																																																																																																																																																																												// Studio
																																																																																																																																																																																																												...
																																																																																																																																																																																																												// class="'+m+'">„
																																																																																																																																																																																																												// …'+b.i18n("dontforget")+"
																																																																																																																																																																																																												// ”</div>"),o.push("</div>"),o.push('<div
																																																																																																																																																																																																												// id="shortcuts"
																																																																																																																																																																																																												// class="ui-tabs-panel
																																																																																																																																																																																																												// ui-widget-content
																																																																																																																																																																																																												// ui-corner-bottom">'),r.length?(o.push('<div
																																																																																																																																																																																																												// class="ui-widget-content
																																																																																																																																																																																																												// elfinder-help-shortcuts">'),a.each(r,function(a,b){o.push(p.replace(/\{pattern\}/,b[0]).replace(/\{descrip\}/,b[1]))}),o.push("</div>")):o.push('<div
																																																																																																																																																																																																												// class="elfinder-help-disabled">'+b.i18n("shortcutsof")+"</div>"),o.push("</div>"),o.push('<div
																																																																																																																																																																																																												// id="help"
																																																																																																																																																																																																												// class="ui-tabs-panel
																																																																																																																																																																																																												// ui-widget-content
																																																																																																																																																																																																												// ui-corner-bottom">'),o.push('<a
																																																																																																																																																																																																												// href="http://elrte.org/redmine/projects/elfinder/boards"
																																																																																																																																																																																																												// target="_blank"
																																																																																																																																																																																																												// class="elfinder-dont-panic"><span>DON\'T
																																																																																																																																																																																																												// PANIC</span></a>'),o.push("</div>"),o.push("</div>"),c=a(o.join("")),c.find(".ui-tabs-nav
																																																																																																																																																																																																												// li").hover(function(){a(this).toggleClass("ui-state-hover")}).children().click(function(b){var
																																																																																																																																																																																																												// d=a(this);b.preventDefault(),b.stopPropagation(),d.is(".ui-tabs-selected")||(d.parent().addClass("ui-tabs-selected
																																																																																																																																																																																																												// ui-state-active").siblings().removeClass("ui-tabs-selected").removeClass("ui-state-active"),c.find(".ui-tabs-panel").hide().filter(d.attr("href")).show())}).filter(":first").click()},200)}),this.getstate=function(){return
																																																																																																																																																																																																												// 0},this.exec=function(){this.fm.dialog(c,{title:this.title,width:530})}},elFinder.prototype.commands.home=function(){this.title="Home",this.alwaysEnabled=!0,this.updateOnSelect=!1,this.shortcuts=[{pattern:"ctrl+home
																																																																																																																																																																																																												// ctrl+shift+up",description:"Home"}],this.getstate=function(){var
																																																																																																																																																																																																												// a=this.fm.root(),b=this.fm.cwd().hash;return
																																																																																																																																																																																																												// a&&b&&a!=b?0:-1},this.exec=function(){return
																																																																																																																																																																																																												// this.fm.exec("open",this.fm.root())}},elFinder.prototype.commands.info=function(){var
																																																																																																																																																																																																												// b="msg",c=this.fm,d="elfinder-info-spinner",e={calc:c.i18n("calc"),size:c.i18n("size"),unknown:c.i18n("unknown"),path:c.i18n("path"),aliasfor:c.i18n("aliasfor"),modify:c.i18n("modify"),perms:c.i18n("perms"),locked:c.i18n("locked"),dim:c.i18n("dim"),kind:c.i18n("kind"),files:c.i18n("files"),folders:c.i18n("folders"),items:c.i18n("items"),yes:c.i18n("yes"),no:c.i18n("no"),link:c.i18n("link")};this.tpl={main:'<div
																																																																																																																																																																																																												// class="ui-helper-clearfix
																																																																																																																																																																																																												// elfinder-info-title"><span
																																																																																																																																																																																																												// class="elfinder-cwd-icon
																																																																																																																																																																																																												// {class}
																																																																																																																																																																																																												// ui-corner-all"/>{title}</div><table
																																																																																																																																																																																																												// class="elfinder-info-tb">{content}</table>',itemTitle:'<strong>{name}</strong><span
																																																																																																																																																																																																												// class="elfinder-info-kind">{kind}</span>',groupTitle:"<strong>{items}:
																																																																																																																																																																																																												// {num}</strong>",row:"<tr><td>{label}
																																																																																																																																																																																																												// :
																																																																																																																																																																																																												// </td><td>{value}</td></tr>",spinner:'<span>{text}</span>
																																																																																																																																																																																																												// <span
																																																																																																																																																																																																												// class="'+d+'"/>'},this.alwaysEnabled=!0,this.updateOnSelect=!1,this.shortcuts=[{pattern:"ctrl+i"}],this.init=function(){a.each(e,function(a,b){e[a]=c.i18n(b)})},this.getstate=function(){return
																																																																																																																																																																																																												// 0},this.exec=function(b){var
																																																																																																																																																																																																												// c=this,f=this.fm,g=this.tpl,h=g.row,i=this.files(b),j=i.length,k=[],l=g.main,m="{label}",n="{value}",o={title:this.title,width:"auto",close:function(){a(this).elfinderdialog("destroy")}},p=[],q=function(a){r.find("."+d).parent().text(a)},r,s,t,u,v,w;if(!j)return
																																																																																																																																																																																																												// a.Deferred().reject();j==1?(u=i[0],l=l.replace("{class}",f.mime2class(u.mime)),v=g.itemTitle.replace("{name}",u.name).replace("{kind}",f.mime2kind(u)),u.tmb&&(t=f.option("tmbUrl")+u.tmb),u.read?u.mime!="directory"||u.alias?s=f.formatSize(u.size):(s=g.spinner.replace("{text}",e.calc),p.push(u.hash)):s=e.unknown,k.push(h.replace(m,e.size).replace(n,s)),u.alias&&k.push(h.replace(m,e.aliasfor).replace(n,u.alias)),k.push(h.replace(m,e.path).replace(n,f.escape(f.path(u.hash)))),u.read&&k.push(h.replace(m,e.link).replace(n,'<a
																																																																																																																																																																																																												// href="'+f.url(http://x10powered.com/errors/404.shtml)+'"
																																																																																																																																																																																																												// target="_blank">'+u.name+"</a>")),u.dim?k.push(h.replace(m,e.dim).replace(n,u.dim)):u.mime.indexOf("image")!==-1&&(k.push(h.replace(m,e.dim).replace(n,g.spinner.replace("{text}",e.calc))),f.request({data:{cmd:"dim",target:u.hash},preventDefault:!0}).fail(function(){q(e.unknown)}).done(function(a){q(a.dim||e.unknown)})),k.push(h.replace(m,e.modify).replace(n,f.formatDate(u.date))),k.push(h.replace(m,e.perms).replace(n,f.formatPermissions(u))),k.push(h.replace(m,e.locked).replace(n,u.locked?e.yes:e.no))):(l=l.replace("{class}","elfinder-cwd-icon-group"),v=g.groupTitle.replace("{items}",e.items).replace("{num}",j),w=a.map(i,function(a){return
																																																																																																																																																																																																												// a.mime=="directory"?1:null}).length,w?(k.push(h.replace(m,e.kind).replace(n,w==j?e.folders:e.folders+"
																																																																																																																																																																																																												// "+w+",
																																																																																																																																																																																																												// "+e.files+"
																																																																																																																																																																																																												// "+(j-w))),k.push(h.replace(m,e.size).replace(n,g.spinner.replace("{text}",e.calc))),p=a.map(i,function(a){return
																																																																																																																																																																																																												// a.hash})):(s=0,a.each
(i,function(a,b){s+=b.size}),k.push(h.replace(m,e.kind).replace(n,e.files)),k.push(h.replace(m,e.size).replace(n,f.formatSize(s))))),l=l.replace("{title}",v).replace("{content}",k.join("")),r=f.dialog(l,o),t&&a("<img/>").load(function(){r.find(".elfinder-cwd-icon").css("background",'url("'+t+'") center center no-repeat')}).attr("src",t),p.length&&f.request({data:{cmd:"size",targets:p},preventDefault:!0}).fail(function(){q(e.unknown)}).done(function(a){var b=parseInt(a.size);q(b>=0?f.formatSize(b):e.unknown)})}},elFinder.prototype.commands.mkdir=function(){this.disableOnSearch=!0,this.updateOnSelect=!1,this.mime="directory",this.prefix="untitled folder",this.exec=a.proxy(this.fm.res("mixin","make"),this),this.shortcuts=[{pattern:"ctrl+shift+n"}],this.getstate=function(){return this.fm.cwd().write?0:-1}},elFinder.prototype.commands.mkfile=function(){this.disableOnSearch=!0,this.updateOnSelect=!1,this.mime="text/plain",this.prefix="http://x10powered.com/errors/404.shtml",this.exec=a.proxy(this.fm.res("mixin","make"),this),this.getstate=function(){return this.fm.cwd().write?0:-1}},elFinder.prototype.commands.open=function(){this.alwaysEnabled=!0,this._handlers={dblclick:function(a){a.preventDefault(),this.exec()},"select enable disable reload":function(a){this.update(a.type=="disable"?-1:void 0)}},this.shortcuts=[{pattern:"ctrl+down numpad_enter"+(this.fm.OS!="mac"&&" enter")}],this.getstate=function(b){var b=this.files(b),c=b.length;return c==1?0:c?a.map(b,function(a){return a.mime=="directory"?null:a}).length==c?0:-1:-1},this.exec=function(b){var c=this.fm,d=a.Deferred().fail(function(a){a&&c.error(a)}),e=this.files(b),f=e.length,g,h,i,j;if(!f)return d.reject();if(f==1&&(g=e[0])&&g.mime=="directory")return g&&!g.read?d.reject(["errOpen",g.name,"errPerm"]):c.request({data:{cmd:"open",target:g.hash},notify:{type:"open",cnt:1,hideCnt:!0},syncOnFail:!0});e=a.map(e,function(a){return a.mime!="directory"?a:null});if(f!=e.length)return d.reject();f=e.length;while(f--){g=e[f];if(!g.read)return d.reject(["errOpen",g.name,"errPerm"]);(h=c.url(http:// x10powered.com/errors/404.shtml))||(h=c.options.url,h=h+(h.indexOf("?")===-1?"?":"&")+(c.oldAPI?"cmd=open&current="+g.phash:"cmd=file")+"&target="+g.hash),j="",g.dim&&(i=g.dim.split("x"),j="width="+(parseInt(i[0])+20)+",height="+(parseInt(i[1])+20));if(!window.open(h,"_blank",j+",top=50,left=50,scrollbars=yes,resizable=yes"))return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// d.reject("errPopup")}return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// d.resolve(b)}},elFinder.prototype.commands.paste=function(){this.disableOnSearch=!0,this.updateOnSelect=!1,this.handlers={changeclipboard:function(){this.update()}},this.shortcuts=[{pattern:"ctrl+v
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// shift+insert"}],this.getstate=function(b){if(b){if(a.isArray(b)){if(b.length!=1)return-1;b=this.fm.file(b[0])}}else
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// b=this.fm.cwd();return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// this.fm.clipboard().length&&b.mime=="directory"&&b.write?0:-1},this.exec=function(b){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// c=this.fm,b=b?this.files(b)[0]:c.cwd(),d=c.clipboard(),e=d.length,f=e?d[0].cut:!1,g=f?"errMove":"errCopy",h=[],i=[],j=a.Deferred().fail(function(a){a&&c.error(a)}),k=function(b){return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// b.length&&c._commands.duplicate?c.exec("duplicate",b):a.Deferred().resolve()},l=function(d){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// e=a.Deferred(),g=[],h=function(b,c){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// d=[],e=b.length;while(e--)a.inArray(b[e].name,c)!==-1&&d.unshift(e);return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// d},i=function(a){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// b=g[a],h=d[b],j=a==g.length-1;!h||c.confirm({title:c.i18n(f?"moveFiles":"copyFiles"),text:c.i18n(["errExists",h.name,"confirmRepl"]),all:!j,accept:{label:"btnYes",callback:function(b){!j&&!b?i(++a):k(d)}},reject:{label:"btnNo",callback:function(b){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// c;if(b){c=g.length;while(a<c--)d[g[c]].remove=!0}else
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// d[g[a]].remove=!0;!j&&!b?i(++a):k(d)}},cancel:{label:"btnCancel",callback:function(){e.resolve()}}})},j=function(a){g=h(d,a),g.length?i(0):k(d)},k=function(d){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// d=a.map(d,function(a){return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// a.remove?null:a}),g=d.length,h={},i=[],j;if(!g)return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// e.resolve();j=d[0].phash,d=a.map(d,function(a){return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// a.hash}),c.request({data:{cmd:"paste",dst:b.hash,targets:d,cut:f?1:0,src:j},notify:{type:f?"move":"copy",cnt:g}}).always(function(){c.unlockfiles({files:d})})};if(!d.length)return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// e.resolve();c.oldAPI?k(d):c.option("copyOverwrite")?b.hash==c.cwd().hash?j(a.map(c.files(),function(a){return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// a.phash==b.hash?a.name:null})):c.request({data:{cmd:"ls",target:b.hash},notify:{type:"prepare",cnt:1,hideCnt:!0},preventFail:!0}).always(function(a){j(a.list||[])}):k(d);return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// e},m;if(!e||!b||b.mime!="directory")return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// j.reject();if(!b.write)return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// j.reject([g,d[0].name,"errPerm"]);m=c.parents(b.hash),a.each(d,function(c,e){if(!e.read)return!j.reject([g,d[0].name,"errPerm"]);if(f&&e.locked)return!j.reject(["errLocked",e.name]);if(a.inArray(e.hash,m)!==-1)return!j.reject(["errCopyInItself",e.name]);e.phash==b.hash?i.push(e.hash):h.push({hash:e.hash,phash:e.phash,name:e.name})});return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// a.when(k(i),l(h)).always(function(){f&&c.clipboard([])})}},elFinder.prototype.commands.quicklook=function(){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// b=this,c=b.fm,d=0,e=1,f=2,g=d,h=a.browser.mozilla||a.browser.opera?"keypress":"keydown",i="elfinder-quicklook-navbar-icon",j="elfinder-quicklook-fullscreen",k=function(b){a(document).trigger(a.Event(h,{keyCode:b,ctrlKey:!1,shiftKey:!1,altKey:!1,metaKey:!1}))},l=function(a){return{opacity:0,width:20,height:c.view=="list"?1:20,top:a.offset().top+"px",left:a.offset().left+"px"}},m=function(){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// b=a(window);return{opacity:1,width:o,height:p,top:parseInt(q.position().top+b.scrollTop()),left:parseInt((b.width()-o)/2)}},n=function(a){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// b=document.createElement(a.substr(0,a.indexOf("http://novalx.com/"))),c=b.canPlayType&&b.canPlayType(a);return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// c&&c!==""&&c!="no"},o,p,q,r,s=a('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="elfinder-quicklook-title"/>'),t=a("<div/>"),u=a('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="elfinder-quicklook-info"/>'),v=a('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="'+i+"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// "+i+'-fullscreen"/>').mousedown(function(d){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// e=b.window,f=e.is("."+j),g="scroll."+c.namespace,h=a(window);d.stopPropagation(),f?(e.css(e.data("position")).unbind("mousemove"),h.unbind(g).trigger(b.resize).unbind(b.resize),w.unbind("mouseenter").unbind("mousemove")):(e.data("position",{left:e.css("left"),top:e.css("top"),width:e.width(),height:e.height()}).css({width:"100%",height:"100%"}),a(window).bind(g,function(){e.css({left:parseInt(a(window).scrollLeft())+"px",top:parseInt(a(window).scrollTop())+"px"})}).bind(b.resize,function(a){b.preview.trigger("changesize")}).trigger(g).trigger(b.resize),e.bind("mousemove",function(a){w.stop(!0,!0).show().delay(3e3).fadeOut("slow")}).mousemove(),w.mouseenter(function(){w.stop(!0,!0).show()}).mousemove(function(a){a.stopPropagation()})),w.attr("style","").draggable(f?"destroy":{}),e.toggleClass(j),a(this).toggleClass(i+"-fullscreen-off"),a.fn.resizable&&q.add(e).resizable(f?"enable":"disable").removeClass("ui-state-disabled")}),w=a('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="elfinder-quicklook-navbar"/>').append(a('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="'+i+"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// "+i+'-prev"/>').mousedown(function(){k(37)})).append(v).append(a('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="'+i+"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// "+i+'-next"/>').mousedown(function(){k(39)})).append('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="elfinder-quicklook-navbar-separator"/>').append(a('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="'+i+"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// "+i+'-close"/>').mousedown(function(){b.window.trigger("close")}));this.resize="resize."+c.namespace,this.info=a('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="elfinder-quicklook-info-wrapper"/>').append(t).append(u),this.preview=a('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="elfinder-quicklook-preview
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// ui-helper-clearfix"/>').bind("change",function(a){b.info.attr("style","").hide(),t.removeAttr("class").attr("style",""),u.html("")}).bind("update",function(c){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// d=b.fm,e=b.preview,f=c.file,g='<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="elfinder-quicklook-info-data">{value}</div>',h;f?(!f.read&&c.stopImmediatePropagation(),b.window.data("hash",f.hash),b.preview.unbind("changesize").trigger("change").children().remove(),s.html(d.escape(f.name)),u.html(g.replace(/\{value\}/,f.name)+g.replace(/\{value\}/,d.mime2kind(f))+(f.mime=="directory"?"":g.replace(/\{value\}/,d.formatSize(f.size)))+g.replace(/\{value\}/,d.i18n("modify")+":
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// "+d.formatDate(f.date))),t.addClass("elfinder-cwd-icon
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// ui-corner-all
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// "+d.mime2class(f.mime)),f.tmb&&a("<img/>").hide().appendTo(b.preview).load(function(){t.css("background",'url("'+h+'")
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// center
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// center
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// no-repeat'),a(this).remove()}).attr("src",h=d.tmb(f.hash)),b.info.delay(100).fadeIn(10)):c.stopImmediatePropagation()}),this.window=a('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// class="ui-helper-reset
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// ui-widget
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// elfinder-quicklook"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																						// style="position:absolute"/>').click(function(a){a.stopPropagation
()}).append(a('<div class="elfinder-quicklook-titlebar"/>').append(s).append(a('<span class="ui-icon ui-icon-circle-close"/>').mousedown(function(a){a.stopPropagation(),b.window.trigger("close")}))).append(this.preview.add(w)).append(b.info.hide()).draggable({handle:"div.elfinder-quicklook-titlebar"}).bind("open",function(a){var c=b.window,d=b.value,h;b.closed()&&d&&(h=r.find("#"+d.hash)).length&&(g=e,h.trigger("scrolltoview"),c.css(l(h)).show().animate(m(),550,function(){g=f,b.update(1,b.value)}))}).bind("close",function(a){var c=b.window,f=b.preview.trigger("change"),h=b.value,i=r.find("#"+c.data("hash")),k=function(){g=d,c.hide(),f.children().remove(),b.update(0,b.value)};b.opened()&&(g=e,c.is("."+j)&&v.mousedown(),i.length?c.animate(l(i),500,k):k())}),this.alwaysEnabled=!0,this.value=null,this.handlers={select:function(){this.update(void 0,this.fm.selectedFiles()[0])},error:function(){b.window.is(":visible")&&b.window.data("hash","").trigger("close")},"searchshow searchhide":function(){this.opened()&&this.window.trigger("close")}},this.shortcuts=[{pattern:"space"}],this.support={audio:{ogg:n('audio/ogg; codecs="vorbis"'),mp3:n("audio/mpeg;"),wav:n('audio/wav; codecs="1"'),m4a:n("audio/x-m4a;")||n("audio/aac;")},video:{ogg:n('video/ogg; codecs="theora"'),webm:n('video/webm; codecs="vp8, vorbis"'),mp4:n('video/mp4; codecs="avc1.42E01E"')||n('video/mp4; codecs="avc1.42E01E, mp4a.40.2"')}},this.closed=function(){return g==d},this.opened=function(){return g==f},this.init=function(){var d=this.options,e=this.window,f=this.preview,g,h;o=d.width>0?parseInt(d.width):450,p=d.height>0?parseInt(d.height):300,c.one("load",function(){q=c.getUI(),r=c.getUI("cwd"),e.appendTo("body").zIndex(100+q.zIndex()),a(document).keydown(function(a){a.keyCode==27&&b.opened()&&e.trigger("close")}),a.fn.resizable&&e.resizable({handles:"se",minWidth:350,minHeight:120,resize:function(){f.trigger("changesize")}}),b.change(function(){b.opened()&&(b.value?f.trigger(a.Event("update",{file:b.value})):e.trigger("close"))}),a.each(c.commands.quicklook.plugins||[],function(a,c){typeof c=="function"&&new c(b)}),f.bind("update",function(){b.info.show()})})},this.getstate=function(){return this.fm.selected().length==1?g==f?1:0:-1},this.exec=function(){this.enabled()&&this.window.trigger(this.opened()?"close":"open")},this.hideinfo=function(){this.info.stop(!0).hide()}},elFinder.prototype.commands.quicklook.plugins=[function(b){var c=["image/jpeg","image/png","image/gif"],d=b.preview;a.each(navigator.mimeTypes,function(b,d){var e=d.type;e.indexOf("image/index.html")===0&&a.inArray(e,c)&&c.push(e)}),d.bind("update",function(e){var f=e.file,g;a.inArray(f.mime,c)!==-1&&(e.stopImmediatePropagation(),g=a("<img/>").hide().appendTo(d).load(function(){setTimeout(function(){var a=(g.width()/g.height()).toFixed(2);d.bind("changesize",function(){var b=parseInt(d.width()),c=parseInt(d.height()),e,f;a<(b/c).toFixed(2)?(f=c,e=Math.floor(f*a)):(e=b,f=Math.floor(e/a)),g.width(e).height(f).css("margin-top",f<c?Math.floor((c-f)/2):0)}).trigger("changesize"),b.hideinfo(),g.fadeIn(100)},1)}).attr("src",b.fm.url(http:// x10powered.com/errors/404.shtml)))})},function(b){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// c=["text/html","application/xhtml+xml"],d=b.preview,e=b.fm;d.bind("update",function(f){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// g=f.file,h;a.inArray(g.mime,c)!==-1&&(f.stopImmediatePropagation(),d.one("change",function(){!h.isResolved()&&!h.isRejected()&&h.reject()}),h=e.request({data:{cmd:"get",target:g.hash,current:g.phash},preventDefault:!0}).done(function(c){b.hideinfo(),doc=a('<iframe
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// class="elfinder-quicklook-preview-html"/>').appendTo(d)[0].contentWindow.document,doc.open(),doc.write(c.content),doc.close()}))})},function(b){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// c=b.fm,d=c.res("mimes","text"),e=b.preview;e.bind("update",function(f){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// g=f.file,h=g.mime,i;if(h.indexOf("text/index.html")===0||a.inArray(h,d)!==-1)f.stopImmediatePropagation(),e.one("change",function(){!i.isResolved()&&!i.isRejected()&&i.reject()}),i=c.request({data:{cmd:"get",target:g.hash},preventDefault:!0}).done(function(d){b.hideinfo(),a('<div
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// class="elfinder-quicklook-preview-text-wrapper"><pre
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// class="elfinder-quicklook-preview-text">'+c.escape(d.content)+"</pre></div>").appendTo(e)})})},function(b){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// c=b.fm,d="application/pdf",e=b.preview,f=!1;a.browser.safari&&navigator.platform.indexOf("Mac")!=-1||a.browser.msie?f=!0:a.each(navigator.plugins,function(b,c){a.each(c,function(a,b){if(b.type==d)return!(f=!0)})}),f&&e.bind("update",function(f){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// g=f.file,h;g.mime==d&&(f.stopImmediatePropagation(),e.one("change",function(){h.unbind("load").remove()}),h=a('<iframe
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// class="elfinder-quicklook-preview-pdf"/>').hide().appendTo(e).load(function(){b.hideinfo(),h.show()}).attr("src",c.url(http://x10powered.com/errors/404.shtml)))})},function(b){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// c=b.fm,d="application/x-shockwave-flash",e=b.preview,f=!1;a.each(navigator.plugins,function(b,c){a.each(c,function(a,b){if(b.type==d)return!(f=!0)})}),f&&e.bind("update",function(f){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// g=f.file,h;g.mime==d&&(f.stopImmediatePropagation(),b.hideinfo(),e.append(h=a('<embed
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// class="elfinder-quicklook-preview-flash"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// pluginspage="http://www.macromedia.com/go/getflashplayer"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// src="'+c.url(http://x10powered.com/errors/404.shtml)+'"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// quality="high"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// type="application/x-shockwave-flash"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// />')))})},function(b){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// c=b.preview,d=!!b.options.autoplay,e={"audio/mpeg":"mp3","audio/mpeg3":"mp3","audio/mp3":"mp3","audio/x-mpeg3":"mp3","audio/x-mp3":"mp3","audio/x-wav":"wav","audio/wav":"wav","audio/x-m4a":"m4a","audio/aac":"m4a","audio/mp4":"m4a","audio/x-mp4":"m4a","audio/ogg":"ogg"},f;c.bind("update",function(g){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// h=g.file,i=e[h.mime];b.support.audio[i]&&(g.stopImmediatePropagation(),f=a('<audio
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// class="elfinder-quicklook-preview-audio"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// controls
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// preload="auto"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// autobuffer><source
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// src="'+b.fm.url(http://x10powered.com/errors/404.shtml)+'"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// /></audio>').appendTo(c),d&&f[0].play())}).bind("change",function(){f&&f.parent().length&&(f[0].pause(),f.remove(),f=null)})},function(b){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// c=b.preview,d=!!b.options.autoplay,e={"video/mp4":"mp4","video/x-m4v":"mp4","video/ogg":"ogg","application/ogg":"ogg","video/webm":"webm"},f;c.bind("update",function(g){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// h=g.file,i=e[h.mime];b.support.video[i]&&(g.stopImmediatePropagation(),b.hideinfo(),f=a('<video
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// class="elfinder-quicklook-preview-video"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// controls
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// preload="auto"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// autobuffer><source
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// src="'+b.fm.url(http://x10powered.com/errors/404.shtml)+'"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// /></video>').appendTo(c),d&&f[0].play())}).bind("change",function(){f&&f.parent().length&&(f[0].pause(),f.remove(),f=null)})},function(b){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// c=b.preview,d=[],e;a.each(navigator.plugins,function(b,c){a.each(c,function(a,b){(b.type.indexOf("audio/index.html")===0||b.type.indexOf("video/index.html")===0)&&d.push(b.type)})}),c.bind("update",function(f){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// g=f.file,h=g.mime,i;a.inArray(g.mime,d)!==-1&&(f.stopImmediatePropagation(),(i=h.indexOf("video/index.html")===0)&&b.hideinfo(),e=a('<embed
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// src="'+b.fm.url(http://x10powered.com/errors/404.shtml)+'"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// type="'+h+'"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// class="elfinder-quicklook-preview-'+(i?"video":"audio")+'"/>').appendTo(c))}).bind("change",function(){e&&e.parent().length&&(e.remove(),e=null)})}],elFinder.prototype.commands.reload=function(){this.alwaysEnabled=!0,this.updateOnSelect=!0,this.shortcuts=[{pattern:"ctrl+shift+r
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// f5"}],this.getstate=function(){return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// 0},this.exec=function(){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// a=this.fm,b=a.sync(),c=setTimeout(function(){a.notify({type:"reload",cnt:1,hideCnt:!0}),b.always(function(){a.notify({type:"reload",cnt:-1})})},a.notifyDelay);return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// b.always(function(){clearTimeout(c),a.trigger("reload")})}},elFinder.prototype.commands.rename=function(){this.disableOnSearch=!0,this.shortcuts=[{pattern:"f2"+(this.fm.OS=="mac"&&"
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// enter")}],this.getstate=function(){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// a=this.fm.selectedFiles();return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// a.length==1&&a[0].phash&&!a[0].locked?0:-1},this.exec=function(){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// b=this.fm,c=b.getUI("cwd"),d=b.selected(),e=d.length,f=b.file(d.shift()),g=".elfinder-cwd-filename",h=a.Deferred().fail(function(a){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// d=i.parent(),e=b.escape(f.name);a&&b.error(a),d.length?(i.remove(),d.html(e)):c.find("#"+f.hash).find(g).html(e)}).always(function(){b.enable()}),i=a('<input
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// type="text"/>').keydown(function(b){b.stopPropagation(),b.stopImmediatePropagation(),b.keyCode==a.ui.keyCode.ESCAPE?h.reject():b.keyCode==a.ui.keyCode.ENTER&&i.blur()}).mousedown(function(a){a.stopPropagation()}).blur(function(){var
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// c=a.trim(i.val()),d=i.parent();if(d.length){if(c==f.name)return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// h.reject();if(!c)return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// h.reject("errInvName");if(b.fileByName(c,f.phash))return
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																											// h.reject(["errExists",c]);d.html
